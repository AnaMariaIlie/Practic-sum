...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetResultButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (operand1 == null || operand1.isEmpty() ||operand2 == null || operand2.isEmpty()
                ...
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameters from client (operands / information type) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), operand1, operand2, informationType, weatherForecastTextView
            );
            clientThread.start();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        op1 = (EditText)findViewById(R.id.op1_edit_text);
        op2 = (EditText)findViewById(R.id.op2_edit_text);
        ...
        getWeatherForecastButton.setOnClickListener(getResultButtonClickListener);
